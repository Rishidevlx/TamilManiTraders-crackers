  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[170px] right-6 bg-white border-2 border-footer text-brand p-4 rounded-full shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center group"
      >
