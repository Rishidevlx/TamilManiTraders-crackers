...
import { FiGrid, FiList, FiChevronDown, FiCheck, FiFilter } from 'react-icons/fi';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full bg-brand text-white px-5 py-2 text-sm font-bold hover:bg-footer hover:text-black transition-colors shadow-sm"
          >
            <FiFilter /> Filter
          </button>
